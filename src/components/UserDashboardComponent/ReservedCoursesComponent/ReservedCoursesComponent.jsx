...
import styles from './ReservedCoursesComponent.module.css'
...
const courseData = [
  {
    id: 1,
    name: 'React Basics',
    instructor: 'دکتر محمدحسین بحر العلومی ',
    startDate: '2023-10-01',
    price: '1,000,000',
    image: '/img/Ellipse 48.png',
    seen: 'unseen',
    status: 'pending'
  },
  {
...
const ReservedCoursesComponent = () => {
    ...
    const filtered = courseData.filter(
      course =>
        (courseName
          ...
          : true) && (startDate ? course.startDate === startDate : true)
    )
...
export default ReservedCoursesComponent
