          ...
          <div>
            ...
            <div className={styles.row}>
              <div className={styles.colInfo}>
                ...
                <p className={styles.infoText}>
                  <strong>کد ملی:</strong> {userInfo.nationalCode}
                </p>
                <p className={styles.infoText}>
                  <strong>ایمیل:</strong> {userInfo.email}
                </p>
                <p className={styles.infoText}>
                  <strong>تاریخ تولد:</strong> {userInfo.birthDate}
                </p>
                <p className={styles.infoText}>
                  <strong>جنسیت:</strong> {userInfo.gender}
                </p>
                <p className={styles.infoText}>
                  <strong>درباره من:</strong> {userInfo.about}
                </p>
              </div>

              <div className={styles.colInfo}>
                <p className={styles.infoText}>
                  <strong>شماره همراه:</strong> {userInfo.phoneNumber}
                </p>
                <p className={styles.infoText}>
                  <strong>تلگرام:</strong> {userInfo.telegram}
                </p>
                <p className={styles.infoText}>
                ...
                <p className={styles.infoText}>
                  <strong>آدرس:</strong> {userInfo.address}
                </p>
                <p className={styles.infoText}>
                  <strong>طول جغرافیایی:</strong> {userInfo.latitude}
                </p>
                <p className={styles.infoText}>
                  <strong>عرض جغرافیایی:</strong> {userInfo.longitude}
                </p>
