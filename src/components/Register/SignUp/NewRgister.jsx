...
import FirstStep from "./FrstStep/FirstStep";
...
const NewRegister = () => {
    ...
    <div style={{direction:'rtl' , fontFamily:'yek'}}>
        <div className="px-[100px] py-[10px] mb-10 flex justify-between" >
            ...
            <button className='nav-button account-button' onClick={handleTitleClick}>
        ...
        <div className="flex justify-center gap-4">
            ...
            <div className="bgRegister w-[650px] h-[550px] relative">
                {StepCounter === 1 && (
