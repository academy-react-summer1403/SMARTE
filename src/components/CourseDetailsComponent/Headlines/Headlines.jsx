  ...
  const headlines = [
    {
      ...
      content: [
        'محتوای مربوط به سرفصل اول.',
        'بخش دوم محتوای سرفصل اول.',
        'بخش سوم محتوای سرفصل اول.'
      ],
        ...
        {headlines.map((headline, index) => (
          <div
            ...
            className={`${styles.headlineItem} ${
              openIndex === index ? styles.activeHeadline : ''
            }`}
          ...
          >
            ...
            <div className={styles.timeContainer}>
              <span className={styles.time}>{headline.time}</span>
            </div>
